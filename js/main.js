...
const API_URL = [
    ['https://api.open-meteo.com/v1/forecast?latitude=', '&longitude=', '&hourly=temperature_2m,apparent_temperature,precipitation,weathercode,cloudcover,windspeed_10m,winddirection_10m&models=best_match&daily=uv_index_max,uv_index_clear_sky_max&current_weather=true&timezone=auto&past_days=2'],
...
async function apiFetch() {
    ...
    for (let i = 0; i < LOCATION_AMOUNT; i++) {
        ...
        LOCATION_ARRAY[i].winddirection = API_DATA_LAND.hourly.winddirection_10m
        ...
        console.log(`Data: ${LOCATION_ARRAY[i].name}`, API_DATA_LAND)
